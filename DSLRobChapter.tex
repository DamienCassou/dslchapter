...
\begin{itemize}
\item Component-based approach for robotics: OROCOS script language, ROCK\footnote{http://rock-robotics.org/} \cite{Joyeux:2011fk}
...
Player-Stage configuration files
...
\item reconfigurable robotics: \cite{Schultz:2007le}
\end{itemize}
\subsection{Planning}
\begin{itemize}
\item PDDL (Planning Domain Definition Language)
\item Smach\footnote{http://www.ros.org/wiki/smach} (finite state machines)
\end{itemize}
